...
const FormPack = ({ currentId, setCurrentId, currentDeleteId, setCurrentDeleteId }) => {
    ...
    const [packData, setPackData] = useState({
        packID: '', packName: '', packDetails: '', ticketID: '', hotelID: '', roomID: '', cabID: '', guideID: '', packPhoto: '', packCost: '', packAvailability: ''
    });
    ...
    const handleSubmit = (e) => {
        ...
        function formater() {
            ...
            packData.packAvailability = capitalize(packData.packAvailability, true);
        ...
        function validate() {
            const fields = [packData.packID, packData.packDetails, packData.ticketID, packData.hotelID, packData.roomID, packData.cabID, packData.guideID, packData.packName, packData.packAvailability, packData.packCost]
            var index = 0;
            if (packData.packID && packData.ticketID && packData.hotelID && packData.roomID && packData.cabID && packData.guideID && packData.packName && packData.packDetails && packData.packAvailability && packData.packCost) {
        ...
        : (
            <div id="main-content" className="container">
                ...
                <form autoComplete="off" noValidate className="" onSubmit={handleSubmit}>
                    ...
                    <span id="warning3" hidden>This field is required!</span><br />
                    ...
                    <TextInput id="packAvailability" label="Availability" placeholder="Enter available days separated by commas" className="validate" value={packData.packAvailability} onChange={(e) => setPackData({ ...packData, packAvailability: e.target.value })} />
